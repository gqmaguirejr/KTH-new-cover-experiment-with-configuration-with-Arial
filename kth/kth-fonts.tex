\ifxeorlua
  ...
  \newfontfamily\cjkfontsf[Script=CJK]{Noto Sans Mono CJK SC}
  \newfontfamily\cjkfonttt[Script=CJK]{Noto Sans Mono CJK SC}
  %\newfontfamily\yiddishfont[Script=Hebrew]{Noto Serif Hebrew}
  %\newfontfamily\yiddishfontsf[Script=Hebrew]{Noto Sans Hebrew}
  %\newfontfamily\hebrewfont[Script=Hebrew]{Noto Serif Hebrew}
  %\newfontfamily\hebrewfontsf[Script=Hebrew]{Noto Sans Hebrew}
  %\newfontfamily\yiddishfonttt[Script=Hebrew]{Noto Sans Mono}
  %\newfontfamily\hebrewfonttt[Script=Hebrew]{Noto Sans Mono}
\else
