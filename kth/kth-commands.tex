 ...
 \foreach \i in {1,...,\countsc{lang}} {
  ...
  \typeout{templangs}
   ...
   %\StrLeft{\@myabstract}{100}[\@myabstract]
    ...
    {fit}{\XMPLangAlt{fit}{pdfsubject={\myabstract}}}%
    {lav}{\XMPLangAlt{lv}{pdfsubject={\myabstract}}}%
    {gre}{\XMPLangAlt{el}{pdfsubject={\myabstract}}}%
    {jpn}{\XMPLangAlt{ja}{pdfsubject={\myabstract}}}%
    {sme}{\XMPLangAlt{se}{pdfsubject={\myabstract}}}%
    {sma}{\XMPLangAlt{sma}{pdfsubject={\myabstract}}}%
    {tur}{\XMPLangAlt{tr}{pdfsubject={\myabstract}}}%
    {heb}{\XMPLangAlt{he}{pdfsubject={\myabstract}}}%
    {ckb}{\XMPLangAlt{ku}{pdfsubject={\myabstract}}}%
    {bos}{\XMPLangAlt{bs}{pdfsubject={\myabstract}}}%
    {slo}{\XMPLangAlt{sk}{pdfsubject={\myabstract}}}%
    {srp}{\XMPLangAlt{sr}{pdfsubject={\myabstract}}}%
    {swa}{\XMPLangAlt{sw}{pdfsubject={\myabstract}}}%
